...
const MangaDetailScreen: React.FC<{ route, navigation }> = ({ route, navigation }) => {
    ...
    return (
        <View style={{flex: 1, position: 'relative'}}>
            ...
            {/*<ScrollView nestedScrollEnabled={true} ref={scrollViewRef} onLayout={handleLayout} onScroll={handleScroll} showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>*/}
            {/*    <View>*/}
            {/*        {*/}
            ...
            {/*                            uri={imageBase64Dict[link].result} width={px2dp(750)} height={px2dp(750/imageBase64Dict[link].width*imageBase64Dict[link].height)}*/}
