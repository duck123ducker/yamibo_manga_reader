        ...
        <View style={[styles.container,{backgroundColor:'#FFEDBB'}]}>
            <DrawerContentScrollView contentContainerStyle={styles.container} {...props}>
                <View style={styles.avatar}>
                    {myInfo.avatarUri === ''?
                        <Image style={[{height: '100%', width: '100%'}, styles.image]} source={require('../../assets/noavatar.png')}/>:
                        <ImageLoader height={px2dp(150)} width={px2dp(150)} resizeMode={'cover'} imageStyle={styles.image} uri={myInfo.avatarUri}/>
                    }
                </View>
