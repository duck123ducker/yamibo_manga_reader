...
const ImageLazyLoad: React.FC<{
  uri: string, width: number, height: number, resizeMode: ImageContentFit, imgWidth: number,
  ...
  ({
    ...
    return (
      <View ref={imageRef} onLayout={handleLayout}>
        <ImageLoader uri={uri} width={width} height={height} resizeMode={resizeMode} imgWidth={imgWidth}
                     imgHeight={imgHeight} visible={myVisible} hideMessage={hideMessage}/>
      </View>
    )
  }
