    ...
    return (
        <>
            ...
            <View style={{backgroundColor:'#f8f8e0', flex:1, position: 'relative'}}>
                ...
                <View style={{backgroundColor: '#FFEDBC', height:px2dp(100), alignItems: 'center', flexDirection: 'row', justifyContent: 'center'}}>
                    <View style={{borderWidth: px2dp(1), borderRadius: px2dp(10), height: px2dp(80), width: px2dp(730), flexDirection: 'row'}}>
                        ...
                        <TextInput allowFontScaling={false} ref={textInputRef} onFocus={onFocus} onBlur={onBlur} onSubmitEditing={onSubmitEditing} onChangeText={onChangeText} style={{paddingLeft: px2dp(10), height: px2dp(78), width: px2dp(572), borderRightWidth: px2dp(1), borderLeftWidth: px2dp(1)}}/>
                ...
                {/*<FlatList onViewableItemsChanged={onViewableItemsChanged} data={(mode === 'normal' ? threadList : (mode === 'search' ? searchThreadList : []))}*/}
                {/*          renderItem={({item, index})=>(*/}
                {/*              <TouchableOpacity key={index} onPress={() => handlePress(item.id, item.author, item.authorName, item.title, item.date)}>*/}
                {/*                  <View style={[styles.manga]}>*/}
                {/*                      <MangaCoverImageLazyLoad style={styles.cover} id={item.id} author={item.author} mode={'flatList'} selfVisible={index>=viewableIds[0]&&index<=viewableIds[1]}/>*/}
